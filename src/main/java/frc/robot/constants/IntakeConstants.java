...
public class IntakeConstants {
  ...
  public static final double BACKWARD_EJECT_CORAL_TOP_MOTOR_VOLTAGE = 7.5;
  public static final double FOREWARD_EJECT_CORAL_TOP_MOTOR_VOLTAGE = -7.5;
  public static final double BACKWARD_EJECT_CORAL_LOW_MOTOR_VOLTAGE = -7.5;
  public static final double FOREWARD_EJECT_CORAL_LOW_MOTOR_VOLTAGE = 7.5;
