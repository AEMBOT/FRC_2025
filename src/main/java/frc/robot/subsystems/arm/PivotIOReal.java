...
public class PivotIOReal implements PivotIO {
  ...
  public void updateInputs(PivotIOInputs inputs) {
    ...
    inputs.pivotSetpointPosition =
        Units.radiansToDegrees(pivotPIDController.getSetpoint().position);
    inputs.pivotSetpointVelocity =
        Units.radiansToDegrees(pivotPIDController.getSetpoint().velocity);
  ...
  public void setAngle(double goalAngleDeg, double elevatorPositionMet) {
    ...
    double pidOutput =
        pivotPIDController.calculate( // convert to radians for our FF equation
    ...
    double feedForward =
        calculatePivotFeedforward( // feedforward in radians
    ...
    Logger.recordOutput(
        "Pivot/VelocityErrorDeg", Units.radiansToDegrees(pivotPIDController.getVelocityError()));
    Logger.recordOutput(
        "Pivot/PositionErrorDeg", Units.radiansToDegrees(pivotPIDController.getPositionError()));
